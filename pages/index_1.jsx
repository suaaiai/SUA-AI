        ...
        <div>
            <div style={card}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <span style={{ fontSize: 12, color: "#aaa" }}>4대보험 + 퇴직금 포함</span>
                </div>
            </div>
            <div style={card}>
...
export default function SuaAI() {
    ...
    return (
        <div style={{ minHeight: "100vh", background: "#0d0d14", fontFamily: "'Pretendard','Apple SD Gothic Neo',sans-serif", color: "#f0f0f8" }}>
                ...
                <div style={{ position: "fixed", inset: 0, background: "#000000bb", zIndex: 999, display: "flex", alignItems: "flex-end" }} onClick={() => setShowFeedback(false)}>
                    <div style={{ background: "#1a1a2e", border: "1px solid #6366f140", borderRadius: "20px 20px 0 0", padding: "28px 24px 40px", width: "100%", position: "relative" }} onClick={e => e.stopPropagation()}>
                        ...
                        <a href={FORMS_URL} target="_blank" rel="noopener noreferrer" style={{ display: "block", textDecoration: "none" }}>
                            <button style={{ width: "100%", padding: "15px", background: "linear-gradient(135deg,#6366f1,#8b5cf6)", border: "none", borderRadius: 12, color: "#fff", fontSize: 15, fontWeight: 700, cursor: "pointer" }}>
                                📝 설문 바로 참여하기
                            </button>
                        </a>
            ...
            <div style={{ display: "flex", borderBottom: "1px solid #ffffff10", background: "#0d0d14", position: "sticky", top: 56, zIndex: 99 }}>
                {TABS.map((t, i) => (
                    <button key={i} onClick={() => setTab(i)} style={{ flex: 1, padding: "12px 4px", border: "none", cursor: "pointer", fontSize: 12, fontWeight: tab === i ? 700 : 400, background: "transparent", color: tab === i ? "#a5b4fc" : "#555", borderBottom: tab === i ? "2px solid #6366f1" : "2px solid transparent", transition: "all 0.2s" }}>{t}</button>
                ))}
            </div>
            ...
            <main style={{ padding: "16px 16px 100px" }}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                                ...
                                <div style={{ padding: "12px 14px", background: primeRating.color + "10", border: "1px solid " + primeRating.color + "30", borderRadius: 10 }}>
                                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                        ...
                                        <div style={{ textAlign: "right" }}>
                                            <div style={{ fontSize: 20, fontWeight: 800, color: primeRating.color }}>{primeCost.toFixed(1)}%</div>
                                ...
                                <div style={{ padding: "14px", background: profitRate > 0 ? "#10b98115" : "#ef444415", border: "1px solid " + (profitRate > 0 ? "#10b98130" : "#ef444430"), borderRadius: 10 }}>
                                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                        ...
                                        <div style={{ textAlign: "right" }}>
                                            <div style={{ fontSize: 20, fontWeight: 800, color: profitRate > 0 ? "#10b981" : "#ef4444" }}>{formatKRW(profitAmount)}</div>
                ...
                {tab === 3 && (
                    <div>
                        ...
                        <div style={card}>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                                {[
                                    ...
                                    <div key={i} style={{ background: "#ffffff05", borderRadius: 10, padding: "12px" }}>
                                        <div style={{ fontSize: 10, color: "#666", marginBottom: 4 }}>{kpi.label}</div>
                        ...
                        {menus.length > 0 && (
                            <div style={card}>
                                <h3 style={secTitle}>메뉴별 Prime Cost 비교</h3>
                                {menus.map(m => {
                                    const pr = getPrimeCostRating(parseFloat(m.primeCost));
                                    return (
                                        <div key={m.id} style={{ marginBottom: 14 }}>
                                            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                                                ...
                                                <span style={{ fontSize: 12, fontWeight: 700, color: pr.color }}>Prime {m.primeCost}%</span>
                                            </div>
